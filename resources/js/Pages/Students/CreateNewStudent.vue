                            ...
                            <div class="card-body p-4">
                                <div class="row g-3">
                                    <div class="col-md-12">
                                        ...
                                        <Multiselect v-model="form.studiedBefore" :options="myOptions"
                                            :placeholder="translate('Please select')" :searchable="true"
                                            :multiple="true" />
                                    ...
                                    <div class="col-md-12" v-if="form.studiedBefore === 'Yes'">
                                        ...
                                        <div class="input-group">
                                            <input type="text" id="regNo" v-model="form.registrationNumber"
                                                class="form-control"
                                    ...
                                    <template v-if="form.studiedBefore !== 'Yes' || studentData">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <Multiselect v-model="form.apply_for" :options="filterOptions" :placeholder="translate('Select Course')
                                                " :searchable="true" :multiple="true" :class="{
                                                    'is-invalid':
                                                        formErrors.apply_for,
                                                }" />
                                            <div v-if="formErrors.apply_for" class="text-primary">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" v-model="form.father" :class="{
                                                'is-invalid': formErrors.father,
                                            }" />
                                            <div v-if="formErrors.father" class="text-danger">
                                                {{ formErrors.father[0] }}
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" v-model="form.reg_no" :class="{
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" v-model="form.cnic" :class="{
                                                'is-invalid': formErrors.cnic,
                                            }" />
                                            <div v-if="formErrors.cnic" class="text-danger">
                                                {{ formErrors.cnic[0] }}
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="date" class="form-control" v-model="form.dob" :class="{
                                                'is-invalid': formErrors.dob,
                                            }" />
                                            <div v-if="formErrors.dob" class="text-danger">
                                                {{ formErrors.dob[0] }}
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <Multiselect v-model="form.country" :options="countryList" :placeholder="translate('Select country')
                                                " :searchable="true" :multiple="true" :class="{
                                                    'is-invalid':
                                                        formErrors.country,
                                                }" />
                                        ...
                                        <template v-if="form.country === 'Afghanistan'">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" v-model="form.visaNumber"
                                                    :class="{
                                                        'is-invalid': formErrors.dob,
                                                    }" />
                                                <div v-if="formErrors.visaNumber" class="text-danger">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <Multiselect v-if="form.country == 'Pakistan'" v-model="form.province"
                                                :options="pakProvinceOptions" :placeholder="translate('Select province')
                                                    " :searchable="true" :multiple="true" :class="{
                                                        'is-invalid':
                                                            formErrors.province,
                                                    }" />
                                            <Multiselect v-if="form.country == 'Afghanistan'" v-model="form.province"
                                                :options="afgProvinceOptions" :placeholder="translate('Select province')
                                                    " :searchable="true" :multiple="true" :class="{
                                                        'is-invalid':
                                                            formErrors.province,
                                                    }" />
                                        ...
                                        <template v-if="form.province">
                                            <div class="col-md-6">
                                                ...
                                                <Multiselect v-model="form.district"
                                                    ...
                                                    :placeholder="translate('Select district')" :searchable="true"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" v-model="form.phone_number"
                                                placeholder="+92 300 1234567" :class="{
                                                    'is-invalid':
                                                        formErrors.phone_number,
                                                }" />
                                            <div v-if="formErrors.phone_number" class="text-danger">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div v-if="formErrors.whatsapp" class="text-danger">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" v-model="form.guardian_name" :class="{
                                                'is-invalid':
                                                    formErrors.guardian_name,
                                            }" />
                                            <div v-if="formErrors.guardian_name" class="text-danger">
                                        ...
                                        <div class="col-md-6" v-if="studentData">
                                            ...
                                            <div v-if="formErrors.hostelite" class="text-danger">
                                        ...
                                        <div class="col-md-12" v-if="form.hostelite === 'yes'">
                                            ...
                                            <input type="text" id="regNo" v-model="form.hostelName"
                                                class="form-control">
                                            <div v-if="formErrors.hostelName" class="text-danger">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" v-model="form.guardian_cnic" :class="{
                                                'is-invalid':
                                                    formErrors.guardian_cnic,
                                            }" />
                                            <div v-if="formErrors.guardian_cnic" class="text-danger">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" v-model="form.guardian_mobile"
                                                :class="{
                                                    'is-invalid':
                                                        formErrors.guardian_mobile,
                                                }" />
                                            <div v-if="formErrors.guardian_mobile" class="text-danger">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" v-model="form.previous_madrasa"
                                                :class="{
                                                    'is-invalid':
                                                        formErrors.previous_madrasa,
                                                }" />
                                            <div v-if="formErrors.previous_madrasa" class="text-danger">
                                        ...
                                        <template v-if="form.apply_for !== 'متوسطا'">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="number" class="form-control" v-model="form.total_marks"
                                                    :class="{
                                                        'is-invalid':
                                                            formErrors.total_marks,
                                                    }" />
                                                <div v-if="formErrors.total_marks" class="text-danger">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="number" class="form-control" v-model="form.obtained_marks"
                                                    :class="{
                                                        'is-invalid':
                                                            formErrors.obtained_marks,
                                                    }" />
                                                <div v-if="formErrors.obtained_marks" class="text-danger">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control" v-model="form.primary_education"
                                                :class="{
                                                    'is-invalid':
                                                        formErrors.primary_education,
                                                }" />
                                            <div v-if="formErrors.primary_education" class="text-danger">
                                                {{
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control" v-model="form.additional_ability"
                                                :class="{
                                                    'is-invalid':
                                                        formErrors.additional_ability,
                                                }" />
                                            <div v-if="formErrors.additional_ability" class="text-danger">
                                                {{
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control" rows="2" v-model="form.permanent_address"
                                                :class="{
                                                    'is-invalid':
                                                        formErrors.permanent_address,
                                                }"></textarea>

                                            <div v-if="formErrors.permanent_address" class="text-danger">
                                                {{
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div v-if="formErrors.current_address" class="text-danger">
                                        ...
                                        <div class="col-md-3 mt-3">
                                            <div class="c-files">
                                                <span class="col-6 col-form-label mt-1">{{ "Image" }}</span>
                                                <br />
                                                <Cropper @croppedImg="croppedImgSubmit" accept=".jpg,.jpeg,.png" />
                                                <br />
                                                <ImageZooming v-if="form.image" :file="form.image" :width="100" />
                                                <ImageZooming v-else :file="existing_image" :width="100" />
                                        ...
                                        <div class="col-md-3">
                                            <div class="c-files">
                                                ...
                                                <br />
                                                <Cropper @croppedImg="cropCNICFront" accept=".jpg,.jpeg,.png" />
                                                <br />
                                                <ImageZooming v-if="form.cnic_front" :file="form.cnic_front"
                                                    :width="100" />
                                                <ImageZooming v-else
                                                    :file="existing_cnic_front ?? '/images/default.jpg'" :width="100" />
                                            </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="c-files">
                                                ...
                                                <br />
                                                <Cropper @croppedImg="cropCNICBack" accept=".jpg,.jpeg,.png" />
                                                <br />
                                                <ImageZooming v-if="form.cnic_back" :file="form.cnic_back"
                                                    :width="100" />
                                                <ImageZooming v-else :file="existing_cnic_back ?? '/images/default.jpg'"
                                                    :width="100" />
                                            </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="c-files">
                                                ...
                                                <br />
                                                <ImageZooming v-if="form.payment_receipt" :file="form.payment_receipt"
                                                    :width="100" />
                                                <ImageZooming v-else
                                            ...
                                            <div class="invalid-feedback animated fadeIn"
                                                v-if="formErrors.payment_receipt">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <Multiselect v-model="form.status" :options="statusOptions"
                                                ...
                                                :allow-empty="false" :placeholder="translate('Select Status')
                                                    " />
                                            <div v-if="formErrors.status" class="text-danger">
                                                {{ formErrors.status[0] }}
                                            </div>
                                        </div>
                                        ...
                                        <!-- Submit -->
                                        <div class="mt-4">
                                            <button type="submit" class="btn btn-success px-4" v-if="formStatus === 1"
                                                @click="submit">
                                                {{ translate("Enroll Now") }}
                                            </button>
                                            <button class="btn btn-secondary px-4" type="button" disabled v-else>
