                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <!-- <input type="text" class="form-control" v-model="selectedName" placeholder="Enter CNIC" /> -->
                            <input
                                type="text"
                                class="form-control"
                        ...
                        <div class="col-md-6">
                            ...
                            <!-- <input type="text" class="form-control" v-model="selectedCnic" placeholder="Enter CNIC" /> -->
                            <input
                                type="text"
                                class="form-control"
                                v-model="selectedCnic"
                                :placeholder="translate('Search by cnic')"
                            />
                        </div>
                    </div>
      ...
      computed: {
        canShowTable() { 
            return (
                ...
                (this.selectedName && this.selectedName.trim() !== "") ||
                (this.selectedCnic && this.selectedCnic.trim() !== "")
            );
        },
        filteredStudents() {
            ...
            return this.students.filter((s) => {
                ...
                const matchCnic =
                    !this.selectedCnic ||
                    String(s.cnic).includes(String(this.selectedCnic));

                return matchSession && matchCourse && matchName && matchCnic;
            });
        },
    },
    created() {
