    ...
    computed: {
        formattedLedger() {
            ...
            return [...this.ledger]
                ...
                .map((entry) => {
                    const cash_in = entry.cash_in ?? 0;
                    const cash_out = entry.cash_out ?? 0;
    ...
    methods: {
        ...
        formatCurrency(amount) {
            return new Intl.NumberFormat("en-PK", {
                ...
                .format(amount)
                .replace(/[^\d.,]/g, ""); // Removes currency symbol
        },
    },
};
</script>
