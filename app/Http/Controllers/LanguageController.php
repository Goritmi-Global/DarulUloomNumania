...
class LanguageController extends Controller
{
    ...
    // languages_index is for super admin where he can do any thing with the langueges can delete update etc...
    ...
    // languages function is for all other modules that are using the languages
    ...
    {
        return Inertia::render('Language/Update', [
            'language_id' => $id,
        ]);
    }
